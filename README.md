...
## TO DO
- Delete scripts commands before copying code to coderpad

-----------------------------------------------------

## Running React on CoderPad

This pad is running a React app that is served by Vite.  Changes are automatically applied as you type them, and you can add as many files to the project as you need.
